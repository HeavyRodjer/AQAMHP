...
public class MainPageMHP_EnterTheCity extends basePage {
    public MainPageMHP_EnterTheCity(WebDriver driver) {
        super(driver);
    }
    ...
    public final By business_trip_button_save= By.xpath("//a[@id= '41ad9118-966e-847d-5c5a-bd524fbeef74_2e337967-ab8a-da97-36a0-6a71204b20de']");
   WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(EXPLICT_WAIT));
    public MainPageMHP_EnterTheCity clickbutton() throws AWTException, InterruptedException {
        Thread.sleep(5000);
    ...
    public MainPageMHP_EnterTheCity click_button_business_trip(){
    ...
    public MainPageMHP_EnterTheCity click_button_business_trip_region(){
        WebElement test = wait.until(ExpectedConditions.presenceOfElementLocated(business_trip_region));
        test.click();
        return null;
    }
    public MainPageMHP_EnterTheCity change_iframe(){
    ...
    public MainPageMHP_EnterTheCity change_type_business_trips(){
    ...
    public MainPageMHP_EnterTheCity change_iframe_city(){
    ...
    public MainPageMHP_EnterTheCity change_iframe_city2(){
    ...
    public MainPageMHP_EnterTheCity change_iframe_Enterprise(){
    ...
    public MainPageMHP_EnterTheCity change_goal_business_trips(){
    ...
    public MainPageMHP_EnterTheCity change_date_start_business_trips(){
...
//        Assert.assertEquals(test2,"Завершення проекту");
    ...
    public MainPageMHP_EnterTheCity change_date_end_business_trips(){
...
//        Assert.assertEquals(test2,"Завершення проекту");
    ...
    public MainPageMHP_EnterTheCity change_save_business_trips(){
        WebElement test = wait.until(ExpectedConditions.elementToBeClickable(business_trip_button_save));
        test.click();
        String test2 = test.getAttribute("innerText");
